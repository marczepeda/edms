...
# Retrieve flat file
# ---------------------------------------------------------------------------
def retrieve(accession: str, file: str=None, dir: str=None, config: bool=True, base_url: str = "https://rest.uniprot.org/uniprotkb") -> None:
    """
    ...
    file (str, optional): Output filename (e.g., FOXA1.txt). Gene name reccommended to match cBioPortal.
    ...
    if file is None: file = f"{accession}.txt" # Create filename if needed
