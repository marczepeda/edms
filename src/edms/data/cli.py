...
def add_subparser(subparsers, formatter_class=None):
    ...
    parser_uniprot_retrieve.add_argument("--dir", type=str, help="Save flat file to specified directory (Default: None -> only save to config directory)",default=argparse.SUPPRESS)
    ...
    parser_uniprot_retrieve.add_argument("--base_url", type=str, help="Base URL for UniProt REST API (Default: https://rest.uniprot.org/uniprotkb)", default="https://rest.uniprot.org/uniprotkb")
    ...
    parser_pdb_retrieve.add_argument("--base_url", type=str, help="Base URL for RCSB PDB REST API (Default: https://files.rcsb.org/download/)", default="https://files.rcsb.org/download/")
